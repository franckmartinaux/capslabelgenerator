...
# Version 0.5 - 26 Jul 2022 - Adapted to Europe100 ELA036 8 per pages
...
#my $ymargin_mm=16;
my $ymargin_mm=16;  # was 8
####my $xmargin_mm=3;
my $xmargin_mm=6; # was 7
...
&print_logo();
&print_pn();
$yref=$yref-&convert_px(38.1); # WAS 38.1
...
$nb_label=0;
$yref=$ystick;
$xref=$xref+&convert_px(66); # Was 66
while ($nb_label < 7)
{
&print_logo();
&print_pn();
$yref=$yref-&convert_px(38.1);
...
my $pn_x=$xref+0;
print "gsave \n";
print `barcode -b "$opt_pn" -g 170x50+$pn_x+$pn_y -E`;
print "grestore \n";
}
################################################################################
sub convert_px {
