...
print "Tool to make labels in PS format for Packing list \n";
print "\nAuthor : Franck Martinaux, franck\@capsule-sa.co.za \n\n";
print "Usage: label_pack.pl -po <Purchase_Order No> -pn <PN_id> -sn <serialnumber1,serialnumber2,...> -qty <Total_Items_in_Box> -nb <number of labels>\n";
...
my $po_x=$xref+0;
print "gsave \n";
print `barcode -b "ORDER $opt_po" -g 120x35+$po_x+$po_y -E`;
print "grestore \n";
}
################################################################################
sub print_pn {
